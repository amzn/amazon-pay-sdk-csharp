...
{
    /// <summary>
    /// An IPN notification to indicate a change in status for a Capture transaction
    /// </summary>
    public class CaptureNotification : Notification
    {
        /// <summary>
        /// Capture details
        /// </summary>
        ...
        internal CaptureNotification()
            : base(NotificationType.CaptureNotification)
        {
        ...
        public CaptureDetails CaptureDetails
        {
            get
            {
                return this._captureDetails;
            }
            set
            {
                this._captureDetails = value;
            }
        }
    }
}