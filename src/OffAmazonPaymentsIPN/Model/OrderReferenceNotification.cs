...
namespace OffAmazonPaymentsNotifications
{
    ...
    /// </summary>
    public class OrderReferenceNotification : Notification
    {
        /// <summary>
        ...
        /// </summary>
        internal OrderReferenceNotification()
            : base(NotificationType.OrderReferenceNotification)
        {
            
        }

        /// <summary>
        /// Access the Order Reference field
        /// </summary>
