...
{
    /// <summary>
    /// Interface to provide an implementation of the
    /// Sns signature verification algorithm
    /// </summary>
    internal interface ISnsSignatureVerification
    {
        /// <summary>
        ...
        bool VerifyMsgMatchesSignatureV1WithCert(Message snsMessage);
    }
}
