...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class ProviderCreditReversalList
    {
        ...
        {
            foreach (ProviderCreditReversal item in list)
            {
                member.Add(item);
            }
            return this;
        ...
        protected internal String ToXMLFragment()
        {
            ...
            List<ProviderCreditReversal> memberObjList = this.member;
            foreach (ProviderCreditReversal memberObj in memberObjList)
            {
                xml.Append("<member>");
