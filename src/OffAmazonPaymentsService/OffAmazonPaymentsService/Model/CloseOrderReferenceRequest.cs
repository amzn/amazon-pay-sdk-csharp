...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class CloseOrderReferenceRequest
    {
        ...
        /// <summary>
        /// Gets and sets the ClosureReason property.
        /// </summary>
        [XmlElementAttribute(ElementName = "ClosureReason")]
        public String ClosureReason
        {
            get { return this.closureReasonField ; }
            set { this.closureReasonField= value; }
        }



        /// <summary>
        /// Sets the ClosureReason property
        /// </summary>
        /// <param name="closureReason">ClosureReason property</param>
        /// <returns>this instance</returns>
        ...
        /// <summary>
        /// Checks if ClosureReason property is set
        /// </summary>
        /// <returns>true if ClosureReason property is set</returns>
