...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class BillingAgreementStatus
    {
        ...
        /// <summary>
        /// Gets and sets the LastUpdatedTimestamp property.
        /// </summary>
        [XmlElementAttribute(ElementName = "LastUpdatedTimestamp")]
        public DateTime LastUpdatedTimestamp
        {
            get { return this.lastUpdatedTimestampField.GetValueOrDefault(); }
            set { this.lastUpdatedTimestampField = value; }
        }
        ...
        /// </summary>
        /// <param name="lastUpdatedTimestamp">LastUpdatedTimestamp property</param>
        /// <returns>this instance</returns>
        public BillingAgreementStatus WithLastUpdatedTimestamp(DateTime lastUpdatedTimestamp)
        {
            this.lastUpdatedTimestampField = lastUpdatedTimestamp;
            return this;
        }
        ...
        /// <summary>
        /// Checks if LastUpdatedTimestamp property is set
        /// </summary>
        /// <returns>true if LastUpdatedTimestamp property is set</returns>
        ...
        protected internal String ToXMLFragment()
        {
            ...
            if (IsSetLastUpdatedTimestamp())
            {
                xml.Append("<LastUpdatedTimestamp>");
                xml.Append(this.LastUpdatedTimestamp);
                xml.Append("</LastUpdatedTimestamp>");
            }
            if (IsSetReasonCode())
            {
