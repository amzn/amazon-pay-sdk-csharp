...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class GetProviderCreditDetailsResult
    {
        ...
        /// <summary>
        /// Gets and sets the ProviderCreditDetails property.
        /// </summary>
        [XmlElementAttribute(ElementName = "ProviderCreditDetails")]
        public ProviderCreditDetails ProviderCreditDetails
        {
            get { return this.providerCreditDetailsField; }
            set { this.providerCreditDetailsField = value; }
        }



        /// <summary>
        /// Sets the ProviderCreditDetails property
        /// </summary>
        /// <param name="providerCreditDetails">ProviderCreditDetails property</param>
        ...
        /// <summary>
        /// Checks if ProviderCreditDetails property is set
        /// </summary>
        /// <returns>true if ProviderCreditDetails property is set</returns>
        ...
        protected internal String ToXMLFragment()
        {
            ...
            if (IsSetProviderCreditDetails())
            {
                ProviderCreditDetails providerCreditDetailsObj = this.ProviderCreditDetails;
                xml.Append("<ProviderCreditDetails>");
                xml.Append(providerCreditDetailsObj.ToXMLFragment());
                xml.Append("</ProviderCreditDetails>");
            }
            return xml.ToString();
        }
