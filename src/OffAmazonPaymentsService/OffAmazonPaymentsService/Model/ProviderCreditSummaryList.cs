...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class ProviderCreditSummaryList
    {
        ...
        {
            foreach (ProviderCreditSummary item in list)
            {
                member.Add(item);
            }
            return this;
        ...
        protected internal String ToXMLFragment()
        {
            ...
            List<ProviderCreditSummary> memberObjList = this.member;
            foreach (ProviderCreditSummary memberObj in memberObjList)
            {
                xml.Append("<member>");
