...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class GetRefundDetailsRequest
    {
        ...
        public GetRefundDetailsRequest WithSellerId(String sellerId)
        {
        ...
        /// <returns>this instance</returns>
        public GetRefundDetailsRequest WithAmazonRefundId(String amazonRefundId)
        {
        ...
        /// <returns>this instance</returns>
        public GetRefundDetailsRequest WithMWSAuthToken(String mwsAuthToken)
        {
