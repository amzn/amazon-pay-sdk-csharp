...
namespace OffAmazonPaymentsService.Model
{
    ...
    public class CaptureResponse
    {
        ...
        /// <summary>
        /// Gets and sets the CaptureResult property.
        /// </summary>
        [XmlElementAttribute(ElementName = "CaptureResult")]
        public CaptureResult CaptureResult
        {
            get { return this.captureResultField ; }
            set { this.captureResultField = value; }
        }



        /// <summary>
        /// Sets the CaptureResult property
        /// </summary>
        /// <param name="captureResult">CaptureResult property</param>
        ...
        /// <summary>
        /// Checks if CaptureResult property is set
        /// </summary>
        /// <returns>true if CaptureResult property is set</returns>
        ...
        public String ToXML() {
            ...
            xml.Append("<CaptureResponse xmlns=\"http://mws.amazonservices.com/schema/OffAmazonPayments/2013-01-01\">");
            if (IsSetCaptureResult()) {
                CaptureResult  captureResult = this.CaptureResult;
                xml.Append("<CaptureResult>");
                xml.Append(captureResult.ToXMLFragment());
                xml.Append("</CaptureResult>");
            } 
