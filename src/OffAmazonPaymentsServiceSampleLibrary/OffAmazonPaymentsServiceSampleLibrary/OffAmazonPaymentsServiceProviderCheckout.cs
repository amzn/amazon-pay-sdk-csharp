...
{
    public class OffAmazonPaymentsServiceProviderCheckout
    {
       /************************************************************************
        ...
        ***********************************************************************/
        ...
        //Invoke the Capture method without Provider Credit
        ...
        //Invoke the GetProviderCreditDetails method
        public GetProviderCreditDetailsResponse GetProviderCreditDetails(ProviderCreditSummary providerCreditSummary)
        {
            return GetProviderCreditDetailsSample.GetProviderCreditDetails(propertiesCollection, service, providerCreditSummary.ProviderCreditId);
        }
