...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentsNotificationSimpleCheckout.aspx.cs" Inherits="OffAmazonPaymentsNotifications.Samples.SimpleCheckout" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="tb_OrderAmount" ErrorMessage="The order amount is not in number format" ForeColor="Red" ValidationExpression="^[0-9]*\.?[0-9]+$"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
